...
function Botkit(configuration) {
        ...
        this.addQuestion = function(message, cb, capture_options, topic) {
            if (typeof(message) == 'string') {
                message = {
                    text: message,
                    channel: this.source_message.channel,
                    address: this.source_message.address
                };
            } else {
                message.channel = this.source_message.channel;
                message.address = this.source_message.address;
            }
    ...
    botkit.startConversation = function(message, cb) {
        botkit.startConversationInternal(this, message, cb);
    };

    botkit.startConversationInternal = function(bot, message, cb) {
